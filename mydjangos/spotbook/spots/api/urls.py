...
urlpatterns = [
    ...
    path('spot-like-action/<str:spot_id>/', views.spot_like_action_view, name='api-spot-like-action'),
    path('does-user-like/<str:spot_id>/', views.does_user_like, name='check if user likes spot'),
